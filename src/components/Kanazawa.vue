    ...
    <div id="resultBlock">
      <div id="resultAreaBlock" class="Kanazawa">
        ...
        <div id="resultAreaImage" class="sp_on">
          <img src="../assets/Kana_top.jpg" alt="金沢" id="resultAreaImage" />
        </div>
      </div>
      <div id="resultImageBlock">
        <div class="image_thumb">
          <img src="../assets/Kana_兼六園.jpg" alt="観光地1" class="image" />
          <p>兼六園</p>
        </div>
        <div class="image_thumb">
          <img
            src="../assets/Kana_近江町市場.jpg"
            alt="観光地2"
            class="image"
          />
        ...
        <div class="image_thumb">
          <img src="../assets/Kana_21st.jpg" alt="観光地3" class="image" />
          <div class="text"><p>21世紀美術館</p></div>
        </div>
      </div>
      <div id="resultTxtBlock"></div>
