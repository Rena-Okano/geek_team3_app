    ...
    <div id="resultBlock">
      ...
      <div id="resultImageBlock">
        <div class="image_thumb">
          <img src="../assets/Sam_Guri-Amir.jpg" alt="観光地1" class="image" />
          <p>グーリ・アミール廟</p>
        </div>
        <div class="image_thumb">
          <img src="../assets/Sam_food.jpg" alt="観光地2" class="image" />
          <p>ウズベキスタン料理</p>
        </div>
        <div class="image_thumb">
          <img
            src="../assets/Sam_レギスタン広場.jpeg"
            alt="観光地3"
            class="image"
          />
