    ...
    <div id="resultBlock">
      ...
      <div id="resultImageBlock">
        <div class="image_thumb">
          <img src="../assets/Din_Mt.Brandon.jpg" alt="観光地1" class="image" />
          <p>ブランドン山</p>
        </div>
        <div class="image_thumb">
          <img src="../assets/Din_ビーハイブ.jpg" alt="観光地2" class="image" />
          <p>ビーハイブ・ハット</p>
        </div>
        <div class="image_thumb">
          <img src="../assets/Din_dolphin.jpg" alt="観光地3" class="image" />
          <p>ドルフィンウォッチング</p>
        </div>
      </div>
